...
public class BVDCheckHelp
{
  ...
  @Test(priority = 30)
  public void checkDocu3() {
    // TODO do real check here as result of previous test is checked.
    helpPage.getMenuStructure();
    Result.rcEquals(result, "0");
  }
/*
  @Test(priority = 30)
  public void checkColorYourDataDocu() {
    result = HelpPage.openColorYourDataDocu();
    Result.rcEquals(result, "0");
  }

    @Test(priority = 40)
    public void checkGetStartedDocu(){

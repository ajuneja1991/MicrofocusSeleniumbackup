...
public class MultiSeriesLineChart {
    ...
    private String sWidget = "group184";
    private String key;
    private String dims = "browser";
    private String tags = "MultiSeriesLineChart";
    ...
    private List<String> xyaxisTextFields = Arrays.asList("0","20","40","60","80","100","12:00 PM","3/1/2019","12:00 AM","3/2/2019","12:00 PM","3/2/2019","12:00 AM","3/3/2019","5:30 PM","3/3/2019");
    ...
    private String sSourceDashboard = "MultiSeriesLineChart";
    private String datapointLocate="svg path[d*='M 1 0 A 1 1 0 1 0 1 0.0001']";
    private List<String> dataPoint=Arrays.asList("svg path[d^='M 36']","svg path[d^='M 36'][clip-path^='url']");
    private List<String> dataPointshowlegend=Arrays.asList("svg path[d^='M 36'][clip-path^='url']","svg path[d^='M 36'][clip-path^='url']");
    private List<String> dataPointcalculatedProperty=Arrays.asList("svg path[d^='M 36'][clip-path^='url']");
    ...
    private String userName = "TesterMultiSeriesLine";
    private String userLogin;
    private String userPwd = "Test@123";
    private String roleName = "testmultiline";
    private String desc = "For MultiSeriesLine";
    ...
    public void checkData() {
        result = mainPage.linepointCount(sWidget,6);
        Result.rcEquals(result, "0");
    }
    ...
    /*@Test(priority = 170)
    public void setTimeSpanforShowLegend() {
        result = editDashboardPage.setTimeSpanInMinutes("0");
        Result.rcEquals(result, "0");
    }*/
    ...
    public void checkDataforCalculationRule() {
        result = mainPage.linepointCount(sWidget,3);
        Result.rcEquals(result, "0");

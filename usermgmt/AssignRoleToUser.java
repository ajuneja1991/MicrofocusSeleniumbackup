...
/**
 * Created by Eva Sokolyanskaya on 30/01/2017.
 * Test for assignment
 */
public class AssignRoleToUser  {
    ...
    public void setup() {
        ...
        dashboardName = sourceDashboard + "_AssignRoleToUser_" + BROWSER;
        dashboardPath = "C:\\tmp\\" + dashboardName + ".svg";
        sUserLogin = "bvd_tester__AssignRoleToUser";
        roleName = "bvd_role__Assign_Role_To_User";
        roleDescription = "bvd role description Assign Role To User";
